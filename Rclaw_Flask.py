        ...
        while ( ( ( StartLat<LowerEndLat) or (StartLat>UpperEndLat ) ) and ( (StartLong<LowerEndLong) or (StartLong>UpperEndLong) ) ): #Main argument is checking if starting co-ordinates come to within +-2% of destination co-ordinates
            ...
            if(StartLat<EndLat):        #GO NORTH
                ...
                if( StartLong<EndLong ):      #GO NORTH EAST
                    ...
                    M1val = Decimal(FlatMotorOffset) + Decimal(LatGain)
                    M2val = Decimal(FlatMotorOffset) + Decimal(LatGain)+ Decimal(LongGain)
                    #ForwardM1*(EndLat-StartLat)*KpLat*FlatMotorValue
                    #ForwardM2*(EndLat-StartLat)*KpLat*(StartLong-EndLong)*KpLong*FlatMotorValue
                    if (LatGain==0 or LongGain==0):
                        print ("MOTORS STOPPED") 
                    else:
                        print ("GO NORTH WEST with M1:" + str(M1val) + " with M2: " + str(M2val) )
                    ...
                    if (LatGain==0 or LongGain==0):
                        ...
                        print ("GO only NORTH with M1:" + str(M1val) + " with M2: " + str(M2val) )
                ...
                if( StartLong<EndLong ):      #GO SOUTH EAST
                    ...
                    if (LatGain==0 or LongGain==0):
                        ...
                        print ("GO South EAST with backward M1:" + str(M1val) + " with backward M2: " + str(M2val) )
                    ...
                    if (LatGain==0 or LongGain==0):
                        ...
                        print ("GO South WEST with backward M1:" + str(M1val) + " with backward M2: " + str(M2val) )
                    ...
                    if (LatGain==0 or LongGain==0):
                        ...
                        print ("GO only South with backward M1:" + str(M1val) + " with backward M2: " + str(M2val) )
